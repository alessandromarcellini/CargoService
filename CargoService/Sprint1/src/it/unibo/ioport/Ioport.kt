		...
		return { //this:ActionBasciFsm
				...
				state("simulate_pushbutton") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t027",targetState="accepted",cond=whenReply("load_accepted"))
					transition(edgeName="t028",targetState="retrylater",cond=whenReply("load_retrylater"))
					transition(edgeName="t029",targetState="refused",cond=whenReply("load_refused"))
				}	 
				...
				state("inhibited") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="simulate_pushbutton",cond=whenDispatch("enable_ioport"))
					transition(edgeName="t031",targetState="inhibited_drain",cond=whenDispatch("inhibit_ioport"))
				}	 
